...
!developmentChains.includes(network.name)
  ? describe.skip
  : describe("OurToken Uint Test", function () {
      ...
      describe("allowance", () => {
        ...
        it("should approve other address to spend token", async () => {
          ...
          await playerToken.transferFrom(deployer, user1, tokensToSend)
          expect(await playerToken.balanceOf(user1)).to.equal(tokensToSend)
        })
